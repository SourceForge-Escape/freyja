 ...
 *
 * 2001-05-09:
 * Mongoose - Created, based on specs gleamed from a loader by Brett Porter
 ==========================================================================*/
...
#define PACK_HACK 1
#pragma pack(push, pack_hack, 1)
#endif

// Mongoose 2002.03.02, FIXME need to add better size support
...
} __attribute__ ((packed)) ms3d_keyframe_t;
