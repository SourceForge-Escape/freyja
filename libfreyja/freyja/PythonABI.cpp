...
PyObject *py_freyjaCameraDestroy(PyObject *self, PyObject *args)
{
	freyja_ptr camera;
...
PyObject *py_freyjaCameraGetTarget3f(PyObject *self, PyObject *args)
{
	freyja_ptr camera_ptr;
	vec3_t xyz;

	if (!PyArg_ParseTuple(args, "lfff", &camera_ptr, xyz+0, xyz+1, xyz+2))
		return NULL;
...
PyObject *py_freyjaCameraSetTarget3f(PyObject *self, PyObject *args)
{
	freyja_ptr camera_ptr;
	vec_t x;
	vec_t y;
	...
	if (!PyArg_ParseTuple(args, "lfff", &camera_ptr, &x, &y, &z))
		return NULL;
...
PyObject *py_freyjaCameraSetTarget3fv(PyObject *self, PyObject *args)
{
	freyja_ptr camera_ptr;
	vec3_t xyz;
...
PyObject *py_freyjaCameraSetUp3f(PyObject *self, PyObject *args)
{
	freyja_ptr camera_ptr;
	vec_t x;
	vec_t y;
...
PyObject *py_freyjaCameraSetUp3fv(PyObject *self, PyObject *args)
{
	freyja_ptr camera_ptr;
	vec3_t xyz;
...
PyMethodDef Plugin_methods[] = {
	...
	{ "freyjaCameraDestroy", py_freyjaCameraDestroy, METH_VARARGS },
	{ "freyjaCameraGetTarget3f", py_freyjaCameraGetTarget3f, METH_VARARGS },
	{ "freyjaCameraSetTarget3f", py_freyjaCameraSetTarget3f, METH_VARARGS },
	{ "freyjaCameraSetTarget3fv", py_freyjaCameraSetTarget3fv, METH_VARARGS },
	{ "freyjaCameraSetUp3f", py_freyjaCameraSetUp3f, METH_VARARGS },
	{ "freyjaCameraSetUp3fv", py_freyjaCameraSetUp3fv, METH_VARARGS },
