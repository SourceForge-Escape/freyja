...
{
	gFreyjaControl->eventMisc(eShutdown);
}
...
void mgtk_handle_color(int id, float r, float g, float b, float a)
{
	...
	case eColorBackground:
		setColor(OpenGLFreyjaScene::mColorBackground, color);
		freyja_event_set_color(eColorBackground, r, g, b, a);
		break;

	case eColorGrid:
		setColor(OpenGLFreyjaScene::mColorGridLine, color);
		freyja_event_set_color(eColorGrid, r, g, b, a);
		break;

	case eColorVertex:
		setColor(OpenGLFreyjaScene::mColorVertex, color);
		freyja_event_set_color(eColorVertex, r, g, b, a);
		break;

	case eColorVertexHighlight:
		setColor(OpenGLFreyjaScene::mColorVertexHighlight, color);
		freyja_event_set_color(eColorVertexHighlight, r, g, b, a);
		break;

	case eColorMesh:
		setColor(OpenGLFreyjaScene::mColorWireframe, color);
		freyja_event_set_color(eColorMesh, r, g, b, a);
		break;

	case eColorMeshHighlight:
		setColor(OpenGLFreyjaScene::mColorWireframeHighlight, color);
...
{
	freyja_event2i(EVENT_MISC, command);
}
