...
#define freyja_object_t egg_plugin_t
...
PyObject *py_freyjaVertexNormal3f(PyObject *self, PyObject *args)
{
	...
	eggVertexNormalStore3f(index, x, y, z);
	return PyInt_FromLong(0);
}
...
PyObject *initPlugins()
{
    ...
    tmp = PyInt_FromLong(FREYJA_GROUP);
...
int main(int argc, char *argv[])
{
	...
	eggPlugin.exportModel("test.egg", "egg");
